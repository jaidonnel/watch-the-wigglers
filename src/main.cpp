...
void getIntegerInRange(int variable, int min, int max, const char* message) { // Gets an integer from the user and ensures that it is within a particular range
  do {
    Log(message);
...
int main() {
  ...
  getIntegerInRange(numOfPlayers, 0, 4, "Enter the number of players (4 players maximum)");
